...
const events = [
  ...
  //--------------- 2024 GRITT CAMP ---------------//
  {
    ...
    coverImage: "/events/R5RS7535.jpg",
  },
  //--------------------------------------------------------//
    ...
    >
      ...
      >
        ...
        <NuxtLink
          :to="event.url"
          target="_blank"
          aria-label="Link to event photos"
          aria-hidden="false"
        >
          <NuxtPicture
